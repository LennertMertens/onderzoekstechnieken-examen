...
#zelf p value bepalen
1 - pchisq(18.279,df = 4)

# chi verdeling tekenen, rechtszijdige verdeling
xas <- seq(0,20,0.01)
yas <- dchisq(xas,df=4)
plot(xas,yas,col="red",type="l")
yas <- dchisq(xas,df=5)
#Lines een lijn toevoegen op een plot, maar er moet eerst een plot zijn
lines(yas,col="blue",type="l")
