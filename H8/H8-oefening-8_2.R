#H8 oefeningen
#oefening 8.2
#Voeg een kolom kwartaalnummer toe aan het bestand "Budget.csv"

#CSV inlezen
budget <- read.csv(file = "C:/Users/Lennert/onderzoekstechnieken-examen/H8/Budget.csv")
#Tijdsreeks tonen per jaar en de omzet per kwartaal
...
#De punten naast elkaar stijgen en dalen constant afwisselend. 
#We kunnen dus nu bekijken welke exponentiele smoothing 
